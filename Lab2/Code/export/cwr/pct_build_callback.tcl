::namespace eval ::pct::build {
  ...
  proc callback {args} {
    [namespace current]::add_vppack_path "[::subst -nobackslashes -nocommands {/home/b083022053/SC/Lab2/Code/export/parameters/HARDWARE.unevald.parameters}]" "[::subst -nobackslashes -nocommands {simulation/parameters}]"
  }
